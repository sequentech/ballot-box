...
ALTER FUNCTION json_object_set_key(json, TEXT, anyelement) OWNER TO agora_elections;;
...
ALTER FUNCTION json_object_set_path(json, TEXT[], anyelement) OWNER TO agora_elections;;
